...
#ifndef ADAP_PARAMETERS_ESTIMATOR_FORCEAPPLIER_TASK_HPP
#define ADAP_PARAMETERS_ESTIMATOR_FORCEAPPLIER_TASK_HPP

#include "adap_parameters_estimator/ForceApplierBase.hpp"
...
namespace adap_parameters_estimator {
    ...
    public:
         ...
         */
        ForceApplier(std::string const& name = "adap_parameters_estimator::ForceApplier");
