...
class Supervisory
 ...
 def initialize(adap, model, forces, parent = nil)

    @window = Vizkit.load(File.join(File.dirname(__FILE__), 'ParametersStatus.ui'), parent)
